...
class WAConnection extends _5_User_1.WAConnection {
    ...
    async sendButtons(bala, bala2, bala3, bala4){
        const bal = { contentText: bala4, footerText: bala2, buttons: bala3, headerType: 1 }
        const waMessage = await this.prepareMessage(bala, bal, "buttonsMessage", {})
        await this.relayWAMessage(waMessage, { waitForAck: true });
        return waMessage;
    ...
    async sendText(id, message, options = {}) {
        const waMessage = await this.prepareMessage(id, message, 'conversation', options);
        await this.relayWAMessage(waMessage, { waitForAck: options.waitForAck !== false });
        return waMessage;
    }
    /*
